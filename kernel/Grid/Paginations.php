    ...
    public function Paging() {
        ...
        if ($this->page != 1){
            ...
            $this->pervpage = '<li class="page-item">'
                    . '<a href="'.\Vadc::Url($this->uri, $data).'" class="page-link"><<</a></li>'
                    . '<li class="page-item">';
            $data['page']= $this->page - 1;
            $this->pervpage .='<a href="'.\Vadc::Url($this->uri, $data).'" class="page-link"><</a></li>';
        }
        ...
        if ($this->page != $this->total){
            ...
            $nextpage .= '<a href="'.\Vadc::Url($this->uri, $data).'" class="page-link">>></a></li>';
        }
        ...
        if($this->page - 2 > 0){
            ...
            $page2left = '<li class="page-item">'
                    . '<a href="'.\Vadc::Url($this->uri, $data).'" class="page-link">'. ($this->page - 2) .'</a></li>';
        }
        if($this->page - 1 > 0){
            $data['page'] = $this->page - 1;
            $page1left = '<li class="page-item">'
                    . '<a href="'.\Vadc::Url($this->uri, $data).'" class="page-link">'. ($this->page - 1) .'</a></li>';
        }
